...
apple_mobility <- function() {
  ...
  url <- "https://covid19-static.cdn-apple.com/covid19-mobility-data/2007HotfixDev54/v2/en-us/applemobilitytrends-2020-05-09.csv"
  data <- readr::read_csv(url) %>%
    tidyr::pivot_longer(
...
citymapper_mobility <- function() {
  ...
  url <- "https://cdn.citymapper.com/data/cmi/Citymapper_Mobility_Index_20200510.csv"
