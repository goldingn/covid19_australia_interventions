...
apple_mobility <- function() {
  ...
  url <- "https://covid19-static.cdn-apple.com/covid19-mobility-data/2012HotfixDev11/v3/en-us/applemobilitytrends-2020-07-12.csv"
  data <- readr::read_csv(
    url,
    col_types = cols(
      .default = col_double(),
...
citymapper_mobility <- function() {
  ...
  url <- "https://cdn.citymapper.com/data/cmi/Citymapper_Mobility_Index_20200713.csv"
  data <- readr::read_csv(
    url,
    skip = 3,
    col_types = cols(
