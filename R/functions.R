...
nsw_lga_active_cases <- function() {
  ...
  tibble::tribble(
              ~Local.Government.Area, ~Cases,  ~Cases.with.unknown.source, ~Total.tests,   ~Test.rate.per.1000,
                            "Albury",       2,                          0,         2787,                    51,
                 "Armidale Regional",       0,                          0,          943,                    31,
                           "Ballina",       0,                          0,         1867,                    42,
                         "Balranald",       0,                          0,           66,                    28,
                 "Bathurst Regional",       0,                          0,         2016,                    46,
                           "Bayside",       1,                          0,         6815,                    38,
                       "Bega Valley",       0,                          0,         1984,                    58,
                         "Bellingen",       0,                          0,          468,                    36,
                          "Berrigan",       0,                          0,          356,                    41,
                         "Blacktown",       5,                          1,        19632,                    52,
                             "Bland",       0,                          0,          228,                    38,
                           "Blayney",       0,                          0,          288,                    39,
                    "Blue Mountains",       5,                          0,         5449,                    69,
                             "Bogan",       0,                          0,           68,                    26,
                            "Bourke",       0,                          0,           98,                    38,
                        "Brewarrina",       0,                          0,           53,                    33,
                       "Broken Hill",       0,                          0,          495,                    28,
                           "Burwood",       0,                          0,         1262,                    31,
                             "Byron",       0,                          0,         1759,                    50,
                           "Cabonne",       0,                          0,          311,                    23,
                            "Camden",       2,                          1,        11130,                   110,
                      "Campbelltown",       8,                          1,        15373,                    90,
                        "Canada Bay",       0,                          0,         5455,                    57,
              "Canterbury-Bankstown",       5,                          1,        17051,                    45,
                        "Carrathool",       0,                          0,           29,                    10,
                     "Central Coast",       0,                          0,        15788,                    46,
                   "Central Darling",       0,                          0,           48,                    26,
                          "Cessnock",       0,                          0,         2024,                    34,
                   "Clarence Valley",       0,                          0,         1402,                    27,
                             "Cobar",       0,                          0,          139,                    30,
                     "Coffs Harbour",       0,                          0,         2592,                    34,
                          "Coolamon",       0,                          0,          155,                    36,
                         "Coonamble",       0,                          0,           77,                    19,
     "Cootamundra-Gundagai Regional",       0,                          0,          404,                    36,
                             "Cowra",       0,                          0,          417,                    33,
                        "Cumberland",       5,                          0,        10260,                    42,
                    "Dubbo Regional",       0,                          0,         2100,                    39,
                            "Dungog",       0,                          0,          266,                    28,
                      "Edward River",       0,                          0,          489,                    54,
                       "Eurobodalla",       3,                          0,         1814,                    47,
                         "Fairfield",       9,                          0,         9191,                    43,
                        "Federation",       0,                          0,          473,                    38,
                            "Forbes",       0,                          0,          195,                    20,
                     "Georges River",       3,                          0,         6379,                    40,
                         "Gilgandra",       0,                          0,           84,                    20,
                 "Glen Innes Severn",       0,                          0,          260,                    29,
                 "Goulburn Mulwaree",       0,                          0,         1290,                    41,
                "Greater Hume Shire",       0,                          0,          536,                    50,
                          "Griffith",       0,                          0,         1183,                    44,
                          "Gunnedah",       0,                          0,          369,                    29,
                            "Gwydir",       0,                          0,           82,                    15,
                        "Hawkesbury",       0,                          0,         3978,                    59,
                               "Hay",       0,                          0,           58,                    20,
                          "Hilltops",       0,                          0,          645,                    34,
                           "Hornsby",       0,                          0,         6302,                    41,
                      "Hunters Hill",       0,                          0,         1566,                   105,
                        "Inner West",       0,                          0,        14281,                    71,
                          "Inverell",       0,                          0,          517,                    31,
                             "Junee",       0,                          0,          179,                    27,
                           "Kempsey",       0,                          0,          972,                    33,
                             "Kiama",       0,                          0,         1405,                    60,
                       "Ku-ring-gai",       0,                          0,         7954,                    63,
                            "Kyogle",       0,                          0,          218,                    25,
                           "Lachlan",       0,                          0,          173,                    28,
                    "Lake Macquarie",       2,                          0,         8855,                    43,
                         "Lane Cove",       0,                          0,         4853,                   121,
                            "Leeton",       0,                          0,          296,                    26,
                           "Lismore",       0,                          0,         1926,                    44,
                           "Lithgow",       0,                          0,          805,                    37,
                         "Liverpool",      20,                          0,        18813,                    83,
                  "Liverpool Plains",       0,                          0,          257,                    33,
                          "Lockhart",       0,                          0,          105,                    32,
                          "Maitland",       0,                          0,         4349,                    51,
                         "Mid-Coast",       0,                          0,         2843,                    30,
              "Mid-Western Regional",       0,                          0,         1118,                    44,
                      "Moree Plains",       0,                          0,          303,                    23,
                            "Mosman",       0,                          0,         1565,                    51,
                      "Murray River",       0,                          0,          136,                    11,
                      "Murrumbidgee",       0,                          0,          138,                    35,
                      "Muswellbrook",       0,                          0,          732,                    45,
                          "Nambucca",       0,                          0,          553,                    28,
                          "Narrabri",       0,                          0,          318,                    24,
                        "Narrandera",       0,                          0,          138,                    23,
                         "Narromine",       0,                          0,          192,                    29,
                         "Newcastle",       0,                          0,         9149,                    55,
                      "North Sydney",       0,                          0,         3159,                    42,
                  "Northern Beaches",       0,                          0,        13148,                    48,
                            "Oberon",       0,                          0,          156,                    29,
                            "Orange",       0,                          0,         1935,                    46,
                            "Parkes",       0,                          0,          375,                    25,
                        "Parramatta",       4,                          0,         9806,                    38,
                           "Penrith",       3,                          2,        14245,                    67,
           "Port Macquarie-Hastings",       0,                          0,         3258,                    39,
                     "Port Stephens",       0,                          0,         3097,                    42,
      "Queanbeyan-Palerang Regional",       0,                          0,         1701,                    28,
                          "Randwick",       0,                          0,         8647,                    56,
                   "Richmond Valley",       0,                          0,          925,                    39,
                              "Ryde",       0,                          0,         5622,                    43,
                      "Shellharbour",       1,                          0,         4214,                    58,
                        "Shoalhaven",       0,                          0,         4213,                    40,
                         "Singleton",       0,                          0,         1275,                    54,
             "Snowy Monaro Regional",       0,                          0,          862,                    41,
                     "Snowy Valleys",       0,                          0,          547,                    38,
                       "Strathfield",       0,                          0,         2376,                    51,
                  "Sutherland Shire",       4,                          0,        15077,                    65,
                            "Sydney",       0,                          0,        12796,                    52,
                 "Tamworth Regional",       0,                          0,         2223,                    36,
                            "Temora",       0,                          0,          180,                    29,
                       "Tenterfield",       0,                          0,          120,                    18,
                   "The Hills Shire",       3,                          0,        10966,                    62,
                             "Tweed",       0,                          0,         3093,                    32,
                "Unincorporated NSW",       0,                          0,            0,                     0,
                "Upper Hunter Shire",       0,                          0,          561,                    40,
               "Upper Lachlan Shire",       0,                          0,          265,                    33,
                            "Uralla",       0,                          0,          127,                    21,
                       "Wagga Wagga",       0,                          0,         3215,                    49,
                            "Walcha",       0,                          0,           79,                    25,
                           "Walgett",       0,                          0,          259,                    44,
                            "Warren",       0,                          0,          159,                    59,
                "Warrumbungle Shire",       0,                          0,          428,                    46,
                          "Waverley",       0,                          0,         4477,                    60,
                            "Weddin",       0,                          0,           91,                    25,
                         "Wentworth",       0,                          0,          330,                    47,
                        "Willoughby",       0,                          0,         3071,                    38,
                     "Wingecarribee",       0,                          0,         4466,                    87,
                       "Wollondilly",       5,                          0,         4267,                    80,
                        "Wollongong",       1,                          1,        11264,                    52,
                         "Woollahra",       0,                          0,         3763,                    63,
                       "Yass Valley",       0,                          0,          405,                    24
     )
