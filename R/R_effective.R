...
saveRDS(fitted_model, "outputs/sa_lockdown_half_reverted/fitted_reff_model.RDS")
# fitted_model <- readRDS("outputs/sa_lockdown_half_reverted/fitted_reff_model.RDS")

# output Reff trajectory draws for Rob M
write_reff_sims(fitted_model, dir = "outputs/sa_lockdown_half_reverted/projection")

# visual checks of model fit
plot_reff_checks(fitted_model)

# do plots for main period
reff_plotting(fitted_model, dir = "outputs/sa_lockdown_half_reverted/")

# and for projected part
reff_plotting(fitted_model,
              dir = "outputs/sa_lockdown_half_reverted/projection",
